                    ...
                    <div class="card">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active p-3" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <form onsubmit="updateProfile(event)">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control _profile_data" name="name" id="name" value="<?php echo $_SESSION["userName"] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="birthday" class="form-label">Date of Birth</label>
                                        <input type="date" class="form-control _profile_data" name="birthday" value="<?php echo $_SESSION["birthday"] ?>" required>
                                    </div>


                                    <div class="mb-3">
                                        <label for="mobile" class="form-label">Mobile Number</label>
                                        <input type="text" class="form-control _profile_data" name="mobile" value="<?php echo $_SESSION["mobile"] ?>" required>
                                    </div>
                                    <div class="form-group form-check mb-3 ">
                                        <input type="checkbox" class="form-check-input pointer" id="exampleCheck1" required>
                                        <label class="form-check-label pointer" for="exampleCheck1">Are you sure ?</label>
                                    </div>

                                    <button type="submit" id="update_profile" class="btn btn-primary">Update profile</button>
                                </form>
                            </div>
                            <div class="tab-pane p-3 fade" id="account" role="tabpanel" aria-labelledby="account-tab">
                                ...
                                <button class="btn btn-danger" onclick="return confirm(`Are you sure?`) && getFunc(`<?php echo $root ?>/settings/config/_update_profile.php?deactivete=<?php echo $_SESSION['userId'] ?>`)">Deactivate Account</button>
                                <hr>
                                <h6 for="" class="text-danger">Delete Account</h6>
                                <p class="text-muted">Once you delete your account. There is no going back.Please! be certain.</p>
                                <button class="btn btn-danger " onclick="return confirm(`Are you sure?`) && getFunc(`<?php echo $root ?>/settings/config/_update_profile.php?delete=<?php echo $_SESSION['userId'] ?>`)">Delete Account</button>
                            ...
                            <div class="tab-pane p-3 fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                                ...
                                <hr>
                                <form onsubmit="submitForm(event,'<?php echo $root ?>/settings/config/_change_pass.php')">
