...
<body>
    ...
    if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] == true) {
        ...
        $action_url = '/e-learning/auth/login/_login.php';
    ?>
        <div class="container">
            ...
            <div class="row justify-content-center g-3 my-2 ">
                <div class="col-lg-6 col-md-9  bg-white shadow-lg rounded p-4">
                    ...
                    <div id="alert_div2" class="alert alert-danger d-none " role="alert">
                        Your account is inactive
                        <a style="cursor: pointer;" onclick="redirectTo('/E-learning/auth/activate/')" class="alert-link">Click here</a>
                    ...
                    <h6 style="cursor: pointer;" onclick="redirectTo('/E-learning/auth/recover')" class="text-center text-primary">Forgotten password?</h6>
                    <p class="text-center text-muted fw-bold">or</p>
                    <button id="" onclick="redirectTo('/E-learning/auth/registration')" class="btn btn-sm btn-success m-auto d-block my-3 fw-bold ">Create new account</button>
