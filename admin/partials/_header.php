<header class="px-3 py-1 fixed-top border-bottom  navbar-white bg-white">
    <div class="">
        <div class="d-flex flex-wrap align-items-center justify-content-between ">
            ...
            <h4 id="NavMenuBarBreand" class="navbar-brand py-2" style="cursor: pointer; display:inline-block;" onclick="redirectTo('/E-learning/admin/')">
                <i class="fa fa-dashboard" aria-hidden="true"></i> Admin dashboard
            </h4>

            <div class="d-flex ms-auto">
                <div class="mx-3">
                    <a class="btn btn-sm btn-outline-secondary mx-1" onclick="redirectTo('/E-learning/')">
                        View Website
                    </a>
...
<div id="SideNavID" class="sideNav NavOpen mt-5 bg-white border">
    <div class="_nav_top">
        <a class="nav-menu-item pointer" onclick="redirectTo('/E-learning/admin/')">
            <i class="fa fa-dashboard m-2"></i>Overview
        </a>
        <a class="nav-menu-item pointer" onclick="redirectTo('/E-learning/admin/courses/')">
            <i class="fa fa-tasks m-2 pointer"></i>Courses
        </a>
        <a class="nav-menu-item pointer" onclick="redirectTo('/E-learning/admin/blog/')">
            <i class="fa fa-tasks m-2 pointer"></i>Blog
        </a>
    ...
    <div class="_nav_bottom">
        <a class="nav-menu-item " style="cursor: pointer;" onclick="redirectTo('/E-learning/settings/')">
